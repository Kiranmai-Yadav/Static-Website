...
2. Deploying the Website on GitHub
   ...
   •	The frontend of Gardening was uploaded to a public GitHub repository: Frontend-Gardening
...
4. Virtual Machines Setup
   ...
   •	VM 1: Created in Availability Zone 1 using Azure Portal. Configured with:
      o	Custom Script Extension to clone the website from GitHub.
      o	Networking settings to connect to the VNet and assigned Subnet.
...
5. Load Balancer Configuration
   ...
   •	Load Balancer: Configured to distribute traffic between VM 1 and VM 2.
      o	Frontend IP Configuration: Assigned a new frontend IP for external access.
      o	Backend Pool: Added both VMs to the backend pool for traffic distribution.
      o	Load Balancing Rule: Defined to balance HTTP traffic (port 80) across the VMs.
      o	Health Probe: Set up to monitor the health of the VMs and ensure traffic is routed only to healthy VMs.


6. Testing and Accessing the Website

   •	After the load balancer deployment, the website became accessible via the frontend IP of the load balancer. Customers can access the Gardening website and buy any kind of plants, gardening tools and pots from it.


How to Use Gardening Website:

   1. Explore our website.
   2. Select the plant or item which you want from the website.
